...
***********************************************************************************************************************/
/***********************************************************************************************************************
* Touch I/F Configuration File  : RA4L1_Project21.tifcfg
* Tuning Log File               : RA4L1_Project21_log_tuning20250320001021.log
***********************************************************************************************************************/
...
{
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x0F5, .snum = 0x07, .sdpa = 0x0F },
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x110, .snum = 0x07, .sdpa = 0x0F },
};
...
const ctsu_cfg_t g_qe_ctsu_cfg_config01 =
{
    ...
    .ctsuchac0  = 0x03, /* ch0-ch7 enable mask */
