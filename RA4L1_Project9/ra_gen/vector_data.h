...
#define VECTOR_NUMBER_GPT0_CAPTURE_COMPARE_A ((IRQn_Type) 4) /* GPT0 CAPTURE COMPARE A (Capture/Compare match A) */
#define GPT0_CAPTURE_COMPARE_A_IRQn          ((IRQn_Type) 4) /* GPT0 CAPTURE COMPARE A (Capture/Compare match A) */
#ifdef __cplusplus
        }
        #endif
#endif /* VECTOR_DATA_H */
